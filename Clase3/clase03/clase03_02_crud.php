...
//El isset verifica que no sea null y que sea una variable declarada
//El signo de preguntra funcionaria como un condicional, va a permitir que clave sea el post de clave 
//en el caso de que sea un int, sino pasa un 0.
